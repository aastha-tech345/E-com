...
import { t as ShopProvider } from "./shop-DLp9rmaL.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-pPptFQFN.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DVleCBUY.css";
...
var Route$4 = createFileRoute("/products/")({
	validateSearch: (search) => ({
		...
		rating: Array.isArray(search.rating) ? search.rating.map((value) => Number(value)).filter((value) => !Number.isNaN(value)) : typeof search.rating === "string" ? search.rating.split(",").map((value) => Number(value)).filter((value) => !Number.isNaN(value)) : typeof search.rating === "number" ? [search.rating] : [],
...
var $$splitComponentImporter = () => import("./admin.products._id.edit-BIgySmC6.mjs");
