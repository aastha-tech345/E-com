...
import { d as productService, p as useShop, s as chatbotService } from "./shop-fTXyFsSH.mjs";
import { g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as cn, t as Button } from "./button-DRsC1qZi.mjs";
import { A as Minimize2, N as Maximize2, b as Send, f as Star, it as Bot, m as Sparkles, r as X } from "../_libs/lucide-react.mjs";
import { t as Input } from "./input-DicJzR9-.mjs";
import { t as Price } from "./Price-DppwMgIf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ShoppingAssistant-CvyCaPM3.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Backend AI · LangGraph flow"
						})]
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "Hi! I can search products, compare options, check orders, track shipping, and help with damaged-item refund or replacement requests."
					}),
...
function ChatBubble({ message, onAdd }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(message.intent || message.orchestrator || message.source) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex max-w-[85%] flex-wrap gap-1.5 text-[11px] text-muted-foreground",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "rounded-full border px-2 py-0.5",
						children: message.source === "fallback" ? "Local fallback" : "Backend AI"
					}),
					message.orchestrator && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "rounded-full border px-2 py-0.5",
						children: message.orchestrator === "langgraph" ? "LangGraph" : message.orchestrator
					}),
					message.intent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "rounded-full border px-2 py-0.5",
						children: formatIntent(message.intent)
					}),
					message.usedTools && message.usedTools.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "rounded-full border px-2 py-0.5",
						children: [message.usedTools.length, " tools used"]
					})
				]
			}),
			backendItems.map((p) => {
			...
			mockItems.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-3 rounded-lg border p-2",
...
function formatIntent(intent) {
	return intent.split("_").map((part) => part.charAt(0).toUpperCase() + part.slice(1)).join(" ");
}
//#endregion
